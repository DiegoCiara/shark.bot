          ...
          <div className="*:data-[slot=card]:shadow-xs @xl/main:grid-cols-3 @5xl/main:grid-cols-4 grid grid-cols-1 w-full gap-4  *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card ">
            <Card className="@container/card w-full">
              <CardHeader className="relative">
                ...
                <div className="absolute right-4 top-4">
                  <Button variant="outline">Solicitar Análise</Button>
                </div>
                <CardDescription>
                  <span className="@[540px]/card:hidden">
                    Análise estratégica da IA do Wave sobre sua base.
                  </span>
                </CardDescription>
              </CardHeader>
              <CardContent className="">
                <p className="h-[108px] text-xs text-ellipsis overflow-auto bg-primary-foreground p-4 rounded-lg">
                  ...
                  consistente e saudável ao longo do 1º trimestre de 2025, com
                  aumento sustentado tanto no volume quanto na qualidade das
                  transações. A consolidação de estratégias comerciais e o foco
                  em fidelização de contatos contribuíram significativamente
                  ...
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    <li>
                      O crescimento não foi impulsionado apenas por ações
                      promocionais de curto prazo, mas por uma base sólida de
                      contatos fiéis e satisfeitos, refletida na alta retenção.
                    </li>
                    <li>
                      A diversificação da carteira de produtos e a
                      personalização da jornada do cliente foram essenciais para
                      sustentar o desempenho.
                    </li>
                    <li>
                      O aumento no ticket médio indica maior valor percebido
                      pelo consumidor, o que reforça a eficácia do
