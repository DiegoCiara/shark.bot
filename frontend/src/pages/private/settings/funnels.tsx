...
import DetailFunnelModal from '@/components/modal/funnel/detail';
import DeleteFunnelModal from '@/components/modal/funnel/delete';
import { formatDate } from '@/utils/formats';
import { AxiosError } from 'axios';
import CreateFunnelModal from '@/components/modal/funnel/create';
      ...
      <main>
        <section className="flex flex-col gap-5 items-start justify-start py-2.5">
          <div className="w-full flex items-center justify-between">
            <h1 className="text-[1.5rem] font-medium m-0">Funis</h1>
