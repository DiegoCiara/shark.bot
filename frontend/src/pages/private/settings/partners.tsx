...
import DetailPartnerModal from '@/components/modal/partner/detail';
import DeletePartnerModal from '@/components/modal/partner/delete';
import { formatDate } from '@/utils/formats';
import { AxiosError } from 'axios';
import CreatePartnerModal from '@/components/modal/partner/create';
      ...
      <main>
        <section className="flex flex-col gap-5 items-start justify-start py-2.5">
          <div className="w-full flex items-center justify-between">
            <h1 className="text-[1.5rem] font-medium m-0">Produtos</h1>
